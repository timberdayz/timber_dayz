...
# 经营成本
# [DELETED] v4.21.0: 经营成本Pydantic模型已迁移到 expense_management.py
...
# [DELETED] v4.21.0: 经营成本API已迁移到 expense_management.py
# 使用 a_class.operating_costs 表(中文字段名)，不再使用 public.operating_costs
