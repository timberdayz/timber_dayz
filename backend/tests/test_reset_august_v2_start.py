...
def test_august_reset_contract_clears_august_business_inputs_and_preserves_collection():
    ...
    for derived_table in (
        ...
        "a_class.personal_performance_plans",
        "a_class.employee_targets",
    ...
    for preserved_table in (
        ...
        assert f"DELETE FROM {preserved_table}" not in source
