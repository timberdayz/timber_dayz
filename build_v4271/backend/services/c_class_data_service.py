...
class CClassDataService:
    ...
    def query_shop_ranking_realtime(
        ...
        raise NotImplementedError(
            "query_shop_ranking 方法已废弃,待实现 OrdersDataService 后修复。"
            "请使用 Metabase Orders Model 或直接查询 b_class.fact_{platform}_orders_{granularity} 表。"
        )
    ...
    def query_shop_sales_for_comparison(
        ...
        # [TODO] 使用 OrdersDataService 或直接查询 b_class.fact_{platform}_orders_{granularity}
        logger.warning(
            "[C-Class] query_comparison_period_sales 方法已废弃,待实现 OrdersDataService 后修复。"
            "返回空字典。"
        )
        return {}
    ...
    def query_shop_sales_by_period(
        ...
        raise NotImplementedError(
            "query_shop_sales_by_period 方法已废弃,待实现 OrdersDataService 后修复。"
            "请使用 Metabase Orders Model 或直接查询 b_class.fact_{platform}_orders_{granularity} 表。"
        )
