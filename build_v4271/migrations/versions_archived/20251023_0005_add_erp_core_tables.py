...
def upgrade() -> None:
    ...
    if 'dim_roles' not in existing_tables:
        ...
        print("[OK] dim_roles table created")
    else:
        print("[SKIP] dim_roles table already exists")
    ...
    if 'dim_users' not in existing_tables:
        ...
        print("[OK] dim_users table created")
    else:
        print("[SKIP] dim_users table already exists")
    ...
    if 'fact_audit_logs' not in existing_tables:
        ...
        print("[OK] fact_audit_logs table created")
    else:
        print("[SKIP] fact_audit_logs table already exists")
    
    # ==================== 3. 创建库存管理表 ====================
    print("[3/11] Creating inventory tables...")
    
    # 创建库存主表
    if 'fact_inventory' not in existing_tables:
        op.create_table(
            'fact_inventory',
        ...
        print("[OK] fact_inventory table created")
    else:
        print("[SKIP] fact_inventory table already exists")
    
    # 创建库存流水表
    if 'fact_inventory_transactions' not in existing_tables:
        op.create_table(
        ...
        print("[OK] fact_inventory_transactions table created")
    else:
        print("[SKIP] fact_inventory_transactions table already exists")
    
    # ==================== 4. 创建财务管理表 ====================
    print("[4/11] Creating finance tables...")
    
    # 创建应收账款表
    if 'fact_accounts_receivable' not in existing_tables:
        op.create_table(
        ...
        print("[OK] fact_accounts_receivable table created")
    else:
        print("[SKIP] fact_accounts_receivable table already exists")
    
    # 创建收款记录表
    if 'fact_payment_receipts' not in existing_tables:
        op.create_table(
        ...
        print("[OK] fact_payment_receipts table created")
    else:
        print("[SKIP] fact_payment_receipts table already exists")
    
    # 创建费用表
    if 'fact_expenses' not in existing_tables:
        op.create_table(
            'fact_expenses',
        ...
        print("[OK] fact_expenses table created")
    else:
        print("[SKIP] fact_expenses table already exists")
    ...
    if 'fact_order_items' not in existing_tables:
        ...
        print("[OK] fact_order_items table created")
    else:
        print("[SKIP] fact_order_items table already exists")
