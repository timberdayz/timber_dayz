...
- Environment file contract: [`docs/guides/ENV_FILE_CONTRACT.md`](F:/Vscode/python_programme/AI_code/xihong_erp/docs/guides/ENV_FILE_CONTRACT.md)
...
- Collection authoring rules: [`docs/guides/COLLECTION_AUTHORING_RULES.md`](F:/Vscode/python_programme/AI_code/xihong_erp/docs/guides/COLLECTION_AUTHORING_RULES.md)
