...
**日期**: 2026-01-11  
**目标**: 修复旧的迁移文件问题，然后测试新迁移文件

---

## 一、修复的问题

### 1.1 问题1：`20251105_add_performance_indexes.py`
...
### 1.2 问题2：`20251115_add_c_class_performance_indexes.py`
...
5. ✅ ...（后续迁移）
6. ✅ `20260111_merge_all_heads -> 20260111_0001_complete_missing_tables` - 新迁移文件
