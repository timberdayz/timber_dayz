...
const overviewPath = path.resolve(__dirname, '../src/views/training/TrainingOverview.vue')
const myTrainingPath = path.resolve(__dirname, '../src/views/training/MyTraining.vue')
const integrationPath = path.resolve(__dirname, '../src/views/training/TrainingIntegration.vue')
const programsPath = path.resolve(__dirname, '../src/views/training/TrainingPrograms.vue')
const assignmentsPath = path.resolve(__dirname, '../src/views/training/TrainingAssignments.vue')
const resultsPath = path.resolve(__dirname, '../src/views/training/TrainingResults.vue')
...
test('training api and management pages expose create, update, binding and sync entry points', () => {
  ...
  const detailPath = path.resolve(__dirname, '../src/views/training/TrainingAssignmentDetail.vue')
