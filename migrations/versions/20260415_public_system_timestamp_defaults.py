"""Repair public system table timestamp defaults.

Revision ID: 20260415_public_system_ts
Revises: 20260415_control_plane_ts
...
revision = "20260415_public_system_ts"
down_revision = "20260415_control_plane_ts"
branch_labels = None
depends_on = None


TARGETS = {
    ("public", "system_logs"): ("created_at",),
    ("public", "security_config"): ("updated_at",),
    ("public", "smtp_config"): ("updated_at",),
    ("public", "system_config"): ("updated_at",),
}
