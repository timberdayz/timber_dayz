...
revision = "20260808_operation_performance_workbench"
down_revision = "20260805_payroll_backfill_audit"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    connection.execute(sa.text(
        ...
        WHERE duplicate.id > keeper.id
          ...
          AND duplicate.breakdown_type = keeper.breakdown_type
          AND duplicate.breakdown_type = 'shop'
