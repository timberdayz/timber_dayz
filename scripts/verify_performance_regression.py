    ...
    plan: list[dict[str, Any]] = [
        {
            ...
            "command": [
                ...
                "-m",
                "pytest",
                "backend/tests/test_account_alignment_compatibility.py",
                "backend/tests/test_auth_token_uniqueness.py",
                "backend/tests/test_high_frequency_pages_probe.py",
                "backend/tests/test_notification_config_routes.py",
                "backend/tests/test_users_me_sessions.py",
                "backend/tests/test_data_quarantine_compatibility.py",
...
def main() -> int:
    ...
    if not summary["all_passed"]:
        ...
        print(
            f"[ERROR] Performance regression failed steps: {len(failed)}/{len(results)}"
        )
        for item in failed:
