...
field_mapping AS (
  ...
  SELECT 
    ...
    COALESCE(raw_data->>'预估回款金额(RMB)', raw_data->>'amount_yu_gu_hui_kuan', raw_data->>'estimated_settlement_rmb', raw_data->>'estimated_settlement', raw_data->>'Estimated Settlement') AS estimated_settlement_amount_raw,
    COALESCE(raw_data->>'利润(RMB)', raw_data->>'profit_rmb', raw_data->>'利润', raw_data->>'profit', raw_data->>'毛利', raw_data->>'Profit') AS profit_raw,
    ...
    COALESCE(raw_data->>'平台佣金(RMB)', raw_data->>'平台佣金', raw_data->>'佣金', raw_data->>'总佣金', raw_data->>'platform_commission_rmb', raw_data->>'platform_commission', raw_data->>'TikTok Shop平台佣金') AS platform_commission_raw,
